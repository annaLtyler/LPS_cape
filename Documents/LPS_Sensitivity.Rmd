...
The first PC odf the temperature matrix is more heavily weighted on 
...
values in PC1 are in cluster 5 above. These are the most reistant to LPS.
Their temperature barely changes at all. The mice with the most positive
values in PC1 are in clusters 4 and 5. These mice had the most dramatic 
...
plot(temp.pc[pc.order], type = "h", col = cl[pc.order], lwd = 3,
    main = "PC1 by cluster")
abline(h = 0)
